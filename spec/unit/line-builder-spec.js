...
var lineBuilder = require('../../app/line-builder');

describe('line-builder', function() {

  it('gets quantity', function() {
    var line = lineBuilder.parse('1 box of chocolates at 11.25');
  ...
  it('gets full line base price', function() {
    var line = lineBuilder.parse('2 box of chocolates at 11.25');
    expect(line.lineBasePrice.toNumber()).to.eq(22.5);
  });

  it('rearranges product name on an imported line', function() {
    var line = lineBuilder.parse('1 box of imported chocolates at 11.25');
  ...
  it('decides taxes on a non exempt line', function() {
    var line = lineBuilder.parse('1 yamayama at 11.25');
